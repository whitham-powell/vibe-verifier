...
"""
    ...
    test_js.write_text(
        """const { add, multiply, complexLogic } = require('./index');
...
"""
    ...
    go_mod.write_text(
        """module example.com/multiproject
...
def mock_subprocess_run(monkeypatch):
    ...
    def mock_run(*args, **kwargs):
        ...
        if "pylint" in cmd:
            ...
            return MockResult(stdout="3 passed, 0 failed", returncode=0)
