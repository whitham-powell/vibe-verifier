...
"""
        ...
        verifier = FormalVerifier(str(temp_dir))
        verifier.verification_targets = {"rust": {"prusti": True, "files": True}}
...
"""
        ...
        mock_run.return_value = MagicMock(
            stdout="VERIFICATION FAILED\nassertion at line 5", stderr="", returncode=1
        )

        verifier = FormalVerifier(str(temp_dir))
        verifier.verification_targets = {"c_cpp": {"cbmc": True, "files": True}}
...
""",
        ...
        verifier.verification_targets = {"python": {"crosshair": True, "files": True}}
    ...
    def test_verify_go_project(self, mock_run, sample_multi_language_project):
        ...
        mock_run.return_value = MagicMock(
            stdout=(
                ...
                '"confidence": "HIGH", "details": "Weak crypto"}]}'
            ),
            stderr="",
            returncode=0,
        )
        ...
        verifier = FormalVerifier(str(sample_multi_language_project))
        verifier.verification_targets = {"go": {"gosec": True, "files": True}}
